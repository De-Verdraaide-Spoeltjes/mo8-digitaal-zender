...
----------------------------------------------------------------------------------
--Command: generate_target bd_964a.bd
--Design : bd_964a
...
entity bd_964a is
  ...
  attribute CORE_GENERATION_INFO of bd_964a : entity is "bd_964a,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_964a,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_964a : entity is "blockdesign_system_ila_0_0.hwdef";
end bd_964a;

architecture STRUCTURE of bd_964a is
  component bd_964a_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
    probe0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    probe1 : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  end component bd_964a_ila_lib_0;
...
begin
  ...
  probe7_1(0) <= probe7(0);
  probe8_1(0) <= probe8(0);
ila_lib: component bd_964a_ila_lib_0
     port map (
      clk => clk_1,
      probe0(0) => probe0_1(0),
      probe1(0) => probe1_1(0),
