...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_8 -L xlslice_v1_0_2 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot communicatieprotocol xil_defaultlib.communicatieprotocol xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim communicatieprotocol -key {Behavioral:sim_1:Functional:communicatieprotocol} -tclbatch cmd.tcl -protoinst "protoinst_files/communicatieprotocol.protoinst" -protoinst "protoinst_files/blockdesign.protoinst" -log simulate.log
}
