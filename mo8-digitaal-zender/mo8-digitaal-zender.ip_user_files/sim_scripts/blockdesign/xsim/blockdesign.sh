...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blockdesign xil_defaultlib.blockdesign xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blockdesign -key {Behavioral:sim_1:Functional:blockdesign} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_964a.protoinst" -protoinst "protoinst_files/blockdesign.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb blockdesign.wdb xsim.dir libdpi.so)
