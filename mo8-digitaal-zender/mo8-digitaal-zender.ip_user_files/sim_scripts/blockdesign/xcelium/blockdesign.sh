...
#
# Script generated by Vivado on Tue Apr 09 13:24:02 +0200 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : blockdesign.sh
...
#
# Usage        : blockdesign.sh
#                blockdesign.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blockdesign.sh [-reset_run]
#                blockdesign.sh [-reset_log]
#                blockdesign.sh [-help]
#
...
#                script (type 'blockdesign.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_lite_ipif_v3_0_4 -libname lib_cdc_v1_0_2 -libname interrupt_control_v3_1_4 -libname axi_gpio_v2_0_30 -libname xil_defaultlib -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_14 -libname processing_system7_vip_v1_0_16 -libname xlconcat_v2_1_4 -libname proc_sys_reset_v5_0_13 -libname generic_baseblocks_v2_1_0 -libname axi_register_slice_v2_1_28 -libname fifo_generator_v13_2_8 -libname axi_data_fifo_v2_1_27 -libname axi_crossbar_v2_1_29 -libname util_vector_logic_v2_0_2 -libname util_reduced_logic_v2_0_4 -libname xlconstant_v1_1_7 -libname axi_protocol_converter_v2_1_28 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_lite_ipif_v3_0_4 lib_cdc_v1_0_2 interrupt_control_v3_1_4 axi_gpio_v2_0_30 xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_14 processing_system7_vip_v1_0_16 xlconcat_v2_1_4 proc_sys_reset_v5_0_13 generic_baseblocks_v2_1_0 axi_register_slice_v2_1_28 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_crossbar_v2_1_29 util_vector_logic_v2_0_2 util_reduced_logic_v2_0_4 xlconstant_v1_1_7 axi_protocol_converter_v2_1_28)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "blockdesign.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blockdesign.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../mo8-digitaal-zender.gen/sources_1/bd/blockdesign/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../mo8-digitaal-zender.gen/sources_1/bd/blockdesign/ipshared/aed8/hdl" +incdir+"../../../../mo8-digitaal-zender.gen/sources_1/bd/blockdesign/ipshared/ec67/hdl" +incdir+"../../../../mo8-digitaal-zender.gen/sources_1/bd/blockdesign/ipshared/aed8/hdl" +incdir+"D:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work util_reduced_logic_v2_0_4 $xmvlog_opts +incdir+"$ref_dir/../../../../mo8-digitaal-zender.gen/sources_1/bd/blockdesign/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../mo8-digitaal-zender.gen/sources_1/bd/blockdesign/ipshared/aed8/hdl" +incdir+"../../../../mo8-digitaal-zender.gen/sources_1/bd/blockdesign/ipshared/ec67/hdl" +incdir+"../../../../mo8-digitaal-zender.gen/sources_1/bd/blockdesign/ipshared/aed8/hdl" +incdir+"D:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.blockdesign xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.blockdesign -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log blockdesign_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./blockdesign.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: blockdesign.sh [-help]\n\
Usage: blockdesign.sh [-step]\n\
Usage: blockdesign.sh [-lib_map_path]\n\
Usage: blockdesign.sh [-reset_run]\n\
Usage: blockdesign.sh [-reset_log]\n\
Usage: blockdesign.sh [-keep_index]\n\
Usage: blockdesign.sh [-noclean_files]\n\n\
