...
#
# Script generated by Vivado on Wed May 22 14:53:08 +0200 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : comProtocol_full_test.sh
...
#
# Usage        : comProtocol_full_test.sh
#                comProtocol_full_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                comProtocol_full_test.sh [-reset_run]
#                comProtocol_full_test.sh [-reset_log]
#                comProtocol_full_test.sh [-help]
#
...
#                script (type 'comProtocol_full_test.sh -help' for more information).
#
...
# script info
echo -e "comProtocol_full_test.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./comProtocol_full_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../mo8-digitaal-zender.gen/sources_1/bd/comProtocol_full_test/ipshared/30ef" +incdir+"../../../../mo8-digitaal-zender.gen/sources_1/bd/comProtocol_full_test/ipshared/30ef" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../mo8-digitaal-zender.gen/sources_1/bd/comProtocol_full_test/ipshared/30ef" +incdir+"../../../../mo8-digitaal-zender.gen/sources_1/bd/comProtocol_full_test/ipshared/30ef" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work fifo_generator_v13_2_8 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../mo8-digitaal-zender.gen/sources_1/bd/comProtocol_full_test/ipshared/30ef" +incdir+"../../../../mo8-digitaal-zender.gen/sources_1/bd/comProtocol_full_test/ipshared/30ef" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../mo8-digitaal-zender.gen/sources_1/bd/comProtocol_full_test/ipshared/30ef" +incdir+"../../../../mo8-digitaal-zender.gen/sources_1/bd/comProtocol_full_test/ipshared/30ef" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xlslice_v1_0_2 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../mo8-digitaal-zender.gen/sources_1/bd/comProtocol_full_test/ipshared/30ef" +incdir+"../../../../mo8-digitaal-zender.gen/sources_1/bd/comProtocol_full_test/ipshared/30ef" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.comProtocol_full_test xil_defaultlib.glbl -o comProtocol_full_test_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./comProtocol_full_test_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key comProtocol_full_test_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc comProtocol_full_test_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./comProtocol_full_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: comProtocol_full_test.sh [-help]\n\
Usage: comProtocol_full_test.sh [-step]\n\
Usage: comProtocol_full_test.sh [-lib_map_path]\n\
Usage: comProtocol_full_test.sh [-reset_run]\n\
Usage: comProtocol_full_test.sh [-reset_log]\n\
Usage: comProtocol_full_test.sh [-keep_index]\n\
Usage: comProtocol_full_test.sh [-noclean_files]\n\n\
