...
vlog -work xpm  -incr -l axi_vip_v1_1_14 -l processing_system7_vip_v1_0_16 "+incdir+../../../../mo8-digitaal-zender.gen/sources_1/bd/comProtocol_full_test/ipshared/30ef" "+incdir+C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" -l xilinx_vip -l xpm -l fifo_generator_v13_2_8 -l xil_defaultlib -l xlslice_v1_0_2 \
...
vlog -work fifo_generator_v13_2_8  -incr -v2k5 "+incdir+../../../../mo8-digitaal-zender.gen/sources_1/bd/comProtocol_full_test/ipshared/30ef" "+incdir+C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" -l xilinx_vip -l xpm -l fifo_generator_v13_2_8 -l xil_defaultlib -l xlslice_v1_0_2 \
...
vlog -work xil_defaultlib  -incr -v2k5 "+incdir+../../../../mo8-digitaal-zender.gen/sources_1/bd/comProtocol_full_test/ipshared/30ef" "+incdir+C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" -l xilinx_vip -l xpm -l fifo_generator_v13_2_8 -l xil_defaultlib -l xlslice_v1_0_2 \
...
vlog -work xlslice_v1_0_2  -incr -v2k5 "+incdir+../../../../mo8-digitaal-zender.gen/sources_1/bd/comProtocol_full_test/ipshared/30ef" "+incdir+C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" -l xilinx_vip -l xpm -l fifo_generator_v13_2_8 -l xil_defaultlib -l xlslice_v1_0_2 \
