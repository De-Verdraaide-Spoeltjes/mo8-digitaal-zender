...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_8 -L xil_defaultlib -L xlslice_v1_0_2 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot comProtocol_full_test xil_defaultlib.comProtocol_full_test xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim comProtocol_full_test -key {Behavioral:sim_1:Functional:comProtocol_full_test} -tclbatch cmd.tcl -protoinst "protoinst_files/blockdesign.protoinst" -protoinst "protoinst_files/comProtocol_full_test.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb comProtocol_full_test.wdb xsim.dir libdpi.so)
