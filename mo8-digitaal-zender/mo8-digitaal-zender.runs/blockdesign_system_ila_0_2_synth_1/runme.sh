...
HD_PWD='C:/_code/Git/MO8/mo8-digitaal-zender/mo8-digitaal-zender/mo8-digitaal-zender.runs/blockdesign_system_ila_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blockdesign_system_ila_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blockdesign_system_ila_0_2.tcl
