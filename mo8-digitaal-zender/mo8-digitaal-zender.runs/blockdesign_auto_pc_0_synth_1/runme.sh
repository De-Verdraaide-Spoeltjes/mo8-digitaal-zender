...
HD_PWD='C:/Users/Jochem/GitHub/Fontys/mo8-digitaal-zender/mo8-digitaal-zender/mo8-digitaal-zender.runs/blockdesign_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blockdesign_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blockdesign_auto_pc_0.tcl
