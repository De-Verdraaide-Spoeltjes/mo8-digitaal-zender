...
HD_PWD='C:/_code/Git/MO8/mo8-digitaal-zender/mo8-digitaal-zender/mo8-digitaal-zender.runs/blockdesign_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blockdesign_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blockdesign_clk_wiz_0_0.tcl
