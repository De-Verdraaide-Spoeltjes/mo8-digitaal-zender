...
HD_PWD='D:/_code/Git/Fontys/Jaar_2/mo8-digitaal-zender/mo8-digitaal-zender/mo8-digitaal-zender.runs/communicatieprotocol_clk_wiz_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log communicatieprotocol_clk_wiz_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source communicatieprotocol_clk_wiz_0.tcl
