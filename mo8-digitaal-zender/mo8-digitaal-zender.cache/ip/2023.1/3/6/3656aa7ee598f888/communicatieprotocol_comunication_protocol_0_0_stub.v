...
/* synthesis syn_black_box black_box_pad_pin="clk,reset,buffer_in[127:0],buffer_data_ready,buffer_read,keypad_data[3:0],data_read_done,data_ready,data_out[191:0]" */;
  input clk;
  input reset;
  input [127:0]buffer_in;
  input buffer_data_ready;
  output buffer_read;
